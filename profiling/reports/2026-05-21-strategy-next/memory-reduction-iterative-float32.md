...
- Benchmark command: `uv run benchmark-memory --backend triton --device cuda --op reduction_sum --numel 16777216 --dtype float32 --block-size 1024 --reduction-strategy iterative --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-21-strategy-next-profiled/memory-reduction-iterative-float32.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-21-strategy-next-profiled/memory-reduction-iterative-float32.jsonl`
...
| --- | ---: | --- | --- |
| Kernel time | 136448 | ns | `gpu__time_duration.sum` |
| DRAM throughput | 93.59 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 74149120 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 2385920 | byte | `dram__bytes_write.sum` |
| Occupancy | 98.57 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
