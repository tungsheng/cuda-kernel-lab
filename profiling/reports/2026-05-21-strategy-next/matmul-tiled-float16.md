...
- Benchmark command: `uv run benchmark-matmul --backend triton --device cuda --m 1024 --n 1024 --k 1024 --dtype float16 --block-m 64 --block-n 64 --block-k 32 --num-warps 4 --num-stages 3 --input-precision tf32 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-21-strategy-next-profiled/matmul-tiled-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-21-strategy-next-profiled/matmul-tiled-float16.jsonl`
- Operation: `matmul`
...
| --- | ---: | --- | --- |
| Kernel time | 57152 | ns | `gpu__time_duration.sum` |
| DRAM throughput | 23.80 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 5729792 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 2413440 | byte | `dram__bytes_write.sum` |
| Occupancy | 22.49 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
...
| Tensor pipe utilization | 45.19 | % | `sm__pipe_tensor_cycles_active.avg.pct_of_peak_sustained_active` |
| Tensor Core utilization | 45.19 | % | `sm__pipe_tensor_op_hmma_cycles_active.avg.pct_of_peak_sustained_active` |
