...
- Benchmark command: `uv run benchmark-decode-step --mode fused-piecewise-graph --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-tail-sweep-live-profiled/decode-step-fused-piecewise-graph-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-tail-sweep-live-profiled/decode-step-fused-piecewise-graph-float16.jsonl`
...
| DRAM throughput | 85.95 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9302016 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8547456 | byte | `dram__bytes_write.sum` |
| Occupancy | 90.14 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
