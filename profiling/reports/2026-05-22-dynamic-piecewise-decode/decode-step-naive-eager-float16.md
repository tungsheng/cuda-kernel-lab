...
- Benchmark command: `uv run benchmark-decode-step --mode naive-eager --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-naive-eager-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-naive-eager-float16.jsonl`
...
| DRAM throughput | 85.12 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9299328 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8517120 | byte | `dram__bytes_write.sum` |
| Occupancy | 90.40 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
