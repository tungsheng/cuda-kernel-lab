...
- Benchmark command: `uv run benchmark-decode-step --mode fused-graph --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-fused-graph-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-fused-graph-float16.jsonl`
...
| --- | ---: | --- | --- |
| Kernel time | 34912 | ns | `gpu__time_duration.sum` |
| DRAM throughput | 85.79 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9300352 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8626944 | byte | `dram__bytes_write.sum` |
| Occupancy | 90.92 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
