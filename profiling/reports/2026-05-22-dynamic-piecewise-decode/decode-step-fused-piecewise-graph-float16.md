...
- Benchmark command: `uv run benchmark-decode-step --mode fused-piecewise-graph --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-fused-piecewise-graph-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-dynamic-piecewise-decode-profiled/decode-step-fused-piecewise-graph-float16.jsonl`
...
| --- | ---: | --- | --- |
| Kernel time | 34496 | ns | `gpu__time_duration.sum` |
| DRAM throughput | 86.44 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9301120 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8542592 | byte | `dram__bytes_write.sum` |
| Occupancy | 89.89 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
