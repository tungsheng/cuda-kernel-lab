...
- Benchmark command: `uv run benchmark-decode-step --dynamic-trace --mode dynamic-eager --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-decode-workflow-improvements-profiled/decode-step-dynamic-eager-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-decode-workflow-improvements-profiled/decode-step-dynamic-eager-float16.jsonl`
...
| DRAM throughput | 85.63 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9299584 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8546048 | byte | `dram__bytes_write.sum` |
| Occupancy | 91.01 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
