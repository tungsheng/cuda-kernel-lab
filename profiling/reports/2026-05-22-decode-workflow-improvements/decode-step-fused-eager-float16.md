...
- Benchmark command: `uv run benchmark-decode-step --mode fused-eager --device cuda --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-22-decode-workflow-improvements-profiled/decode-step-fused-eager-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-22-decode-workflow-improvements-profiled/decode-step-fused-eager-float16.jsonl`
...
| DRAM throughput | 87.14 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 9304832 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 8491264 | byte | `dram__bytes_write.sum` |
| Occupancy | 91.17 | % | `sm__warps_active.avg.pct_of_peak_sustained_active` |
