...
- Benchmark command: `uv run benchmark-norms --backend triton --device cuda --op rmsnorm --rows 4096 --cols 4096 --dtype float16 --warmup 5 --iterations 10 --skip-correctness --output experiments/results/aws-ec2/2026-05-21-tensor-core-matmul-profiled/norms-rmsnorm-float16.jsonl`
- JSONL result: `experiments/results/aws-ec2/2026-05-21-tensor-core-matmul-profiled/norms-rmsnorm-float16.jsonl`
- Operation: `rmsnorm`
...
| --- | ---: | --- | --- |
| Kernel time | 137376 | ns | `gpu__time_duration.sum` |
| DRAM throughput | 91.35 | % | `gpu__dram_throughput.avg.pct_of_peak_sustained_elapsed` |
| DRAM bytes read | 37924096 | byte | `dram__bytes_read.sum` |
| DRAM bytes written | 37289856 | byte | `dram__bytes_write.sum` |
