...
from cuda_kernel_lab.kernels.torch_baselines import softmax as torch_softmax
from cuda_kernel_lab.kernels.triton.softmax import is_available as triton_is_available
from cuda_kernel_lab.kernels.triton.softmax import softmax as triton_softmax
